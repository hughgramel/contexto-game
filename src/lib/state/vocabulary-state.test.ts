...
describe("vocabulary state", () => {
  ...
  it("isolates vocabulary across languages", () => {
    setWordKnown("hello", "Hello", "zh");
    setWordLearning("hola", "Hola", "es");

    expect(getWordStatus("hello", "zh")).toBe("known");
    expect(getWordStatus("hello", "es")).toBe("unknown");

    expect(getWordStatus("hola", "es")).toBe("learning");
    expect(getWordStatus("hola", "zh")).toBe("unknown");
  ...
  it("does not overwrite known with learning", () => {
    setWordKnown("sugoi", "sugoi", "ja");
    setWordLearning("sugoi", "sugoi", "ja");
    expect(getWordStatus("sugoi", "ja")).toBe("known");
  });
